...
@CucumberOptions(features = "featureFiles/Users_In_Repository/Add_Repository_User.feature", glue = "org.test.prolaborate.stepDefinitions", dryRun = !true, strict = true, plugin = {
        "com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:" } , tags = {"@tag1"} )
public class Add_Repository_User {
    @BeforeClass
    public static void before() throws IOException {
        ...
        prop.setProperty("extent.reporter.spark.out", "report/Add_Repository_User.html");
