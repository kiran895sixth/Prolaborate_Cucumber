...
@CucumberOptions(features = "featureFiles/Users_In_Repository/LastActivity_in_repository_user_list.feature", glue = "org.test.prolaborate.stepDefinitions", dryRun = !true, strict = true, plugin = {
        "com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:" } , tags = {"@tag1"} )
public class LastActivity_in_repository_user_list {
    @BeforeClass
    public static void before() throws IOException {
        ...
        prop.setProperty("extent.reporter.spark.out", "report/LastActivity_in_repository_user_list.html");
